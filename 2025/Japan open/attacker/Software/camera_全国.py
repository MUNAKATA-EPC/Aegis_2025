...
###########################################
goal_yellow =(67, 95, -29, -4, 28, 90)# ゴールの色取り用変数(黄色)##A

##goal_yellow =(52, 87, -29, 7, 41, 108)##B
##goal_yellow =(52, 70, -39, 29, 45, 80)
#######################################################
court_green =(62, 93, -19, 34, -28, 11)
# コートの色取り用変数A
##court_green =(34, 85, -21, 6, -37, 11)# コートの色取り用変数B(35, 86, -70, -22, -4, 99)
