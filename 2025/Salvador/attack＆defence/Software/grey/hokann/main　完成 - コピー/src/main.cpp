...
void select_pid()
{
  ...
  else
  {
    ...
    else if (-15 < goal_gyro_dir && goal_gyro_dir < -45 && goal_mode == true)
    {
      goal_mode = true;
      PID_mode = 0;
      move_speed = 85;
    }
    else if (-15 < goal_gyro_dir && goal_gyro_dir < -45 && goal_mode == false)
    {
      goal_mode = false;
      PID_mode = 1;
      move_speed = 60;
    }
    else if (goal_gyro_dir <= -45)
    {
      goal_mode = false;
      PID_mode = 1;
      move_speed = 60;
