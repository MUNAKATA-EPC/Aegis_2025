...
######################
goal_yellow =(66, 94, -27, -3, 70, 22)# ゴールの色取り用変数(黄色)##A
...
while True:
    ...
    # to the IDE. The FPS should increase once disconnected.img.draw_cross(screen_center[0], screen_center[1])
