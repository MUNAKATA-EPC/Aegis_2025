...
void GetDegdata(){
  ...
  microcaldata = (microcaldata - 512) / 20 +20 ;//白20。黒27
  
  microcaldata += 20 ;//白20。黒27
...
void loop() {
  ...
  if(outputdata > 510 && outputdata < 514){
    digitalWrite(ledpin,LOW);
  } else {
    digitalWrite(ledpin,HIGH);
  }
  outputdata = (outputdata - 512) * -1;
  outputdata = outputdata * 0.3515625;
  
  Serial1.print(String(outputdata));
